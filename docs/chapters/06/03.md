...
![Enter image alt description](Images/OZq_Image_3.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.3:</b> Deep Mind (Apr 2020) “[Specification gaming: the flip side of AI ingenuity](https://www.deepmind.com/blog/specification-gaming-the-flip-side-of-ai-ingenuity)”</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/Luz_Image_4.gif){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.4:</b> OpenAI (2017) “[Learning from human preferences](https://openai.com/blog/deep-reinforcement-learning-from-human-preferences/)”</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/mlu_Image_5.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.5:</b> Deep Mind (Apr 2020) “[Specification gaming: the flip side of AI ingenuity](https://www.deepmind.com/blog/specification-gaming-the-flip-side-of-ai-ingenuity)”</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/dod_Image_6.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.6:</b> OpenAI (Jul 2018) “[Learning Montezuma’s Revenge from a single demonstration](https://openai.com/research/learning-montezumas-revenge-from-a-single-demonstration)”</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/bku_Image_7.gif){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.7:</b> Amodei & Clark (2016) “[Faulty reward functions in the wild](https://openai.com/research/faulty-reward-functions)"</figcaption>
</figure>

<figure markdown="span">
![Enter image alt description](Images/dmJ_Image_8.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/VSH_Image_9.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.9:</b> Leo Gao (Nov 2022) “[Clarifying wireheading terminology](https://www.alignmentforum.org/posts/REesy8nqvknFFKywm/clarifying-wireheading-terminology)”</figcaption>
</figure>
