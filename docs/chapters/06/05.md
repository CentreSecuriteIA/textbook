...
<div class="section-meta">
    <div class="meta-item">
        ...
        <div class="meta-content">
            ...
            <div class="meta-value">23 min</div>
        </div>
    </div>
</div>
...
![Enter image alt description](Images/B9Y_Image_12.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/5Wc_Image_13.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/uVN_Image_14.gif){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/CxZ_Image_15.gif){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/a1X_Image_16.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/RjW_Image_17.gif){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/qyP_Image_18.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/367_Image_20.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/bIf_Image_21.png){ loading=lazy }
...
!!! note " Instruction tuning vs alignment"
    ...
    <figure markdown="span">
    ![Enter image alt description](Images/0Ry_Image_22.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/hKt_Image_23.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/33A_Image_24.png){ loading=lazy }
