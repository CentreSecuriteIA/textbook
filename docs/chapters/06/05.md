...
![Enter image alt description](Images/Cjz_Image_12.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.12:</b> DeepMind (Nov 2018) “[Scalable agent alignment via reward modeling](https://deepmindsafetyresearch.medium.com/scalable-agent-alignment-via-reward-modeling-bf4ab06dfd84)”</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/CrP_Image_13.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.13:</b> DeepMind (Nov 2018) “[Scalable agent alignment via reward modeling](https://deepmindsafetyresearch.medium.com/scalable-agent-alignment-via-reward-modeling-bf4ab06dfd84)”</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/2kC_Image_14.gif){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/RUU_Image_16.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.16:</b> OpenAI (Jan 2022) “[Aligning language models to follow instructions](https://openai.com/research/instruction-following)”</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/g9x_Image_17.gif){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.17:</b> Christiano et al (2017) “[Deep Reinforcement Learning From Human Preferences](https://arxiv.org/pdf/1706.03741.pdf)”</figcaption>
</figure>

<figure markdown="span">
![Enter image alt description](Images/eXh_Image_18.png){ loading=lazy }
...
<figure markdown="span">
![CAI Graphic Final](Images/rFA-cai-graphic-final.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.19:</b> [Anthropic \ Claude’s Constitution](https://www.anthropic.com/index/claudes-constitution)</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/pi7_Image_20.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.20:</b> Anthropic, (Dec 2022) “[Constitutional AI: Harmlessness from AI Feedback](https://arxiv.org/pdf/2212.08073.pdf)”</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/Pf4_Image_21.png){ loading=lazy }
...
!!! note " Instruction tuning vs alignment"
    ...
    **Instruction Tuning** is a process where the model is fine-tuned (via RL or supervised learning) to better understand and follow human instructions. This involves training the model on a dataset that contains a variety of instructions and their desired outcomes. The primary goal of Instruction Tuning is to enhance the AI's ability to interpret and execute commands as intended by users. This improves user experience and broadens the model's applicability. For example:
    ...
    <figure markdown="span">
    ![Enter image alt description](Images/ktQ_Image_22.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/XXG_Image_23.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 6.23:</b> ([source](https://substack.com/redirect/368f9504-a956-4ea6-a8b2-4590d91f4870?j=eyJ1IjoiMjVva2NtIn0.A655rLcLajeNZgVuo-WcW5FG8U4WngxCktZZUWRRsYk))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/CPr_Image_24.png){ loading=lazy }
