...
![Enter image alt description](Images/JVJ_Image_2.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/slv_Image_3.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/B1v_Image_4.png){ loading=lazy }
