...
In addressing the mitigation of future potential misuses of powerful AI, two distinct strategies emerge:
...
## 3.3.1 Strategy A: Monitored APIs {: #01 }
...
![Enter image alt description](Images/ZXt_Image_2.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 2:</b> This schema illustrates how an API works. This diagram is very simplified and is for illustration purposes only. OpenAI's API does not work like this.</figcaption>
</figure>

**The necessity of model evaluation.** The first step in this strategy is to identify which models are considered dangerous and which are not via model evaluation. The paper Model Evaluation for Extreme Risks ([source](https://arxiv.org/abs/2305.15324)), which was partly presented during the last chapter, lists a few critical, dangerous capabilities that need to be assessed.
...
<figure markdown="span">
![Enter image alt description](Images/bds_Image_3.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 3:</b> Gradient of system access ([source](https://cdn.governance.ai/Open-Sourcing_Highly_Capable_Foundation_Models_2023_GovAI.pdf))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/TAC_Image_4.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 4:</b> Mechanisms by which differential technology development can reduce negative societal impacts. ([source](https://vitalik.eth.limo/general/2023/11/27/techno_optimism.html))</figcaption>
</figure>
...
!!! quote  "Ajeya Cotra ([source](https://www.vox.com/future-perfect/2024/2/2/24058484/open-source-artificial-intelligence-ai-risk-meta-llama-2-chatgpt-openai-deepfake))"
