...
![Enter image alt description](Images/cK6_Image_7.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 7:</b> An illustration of a framework that we think is robustly good to manage risks.
...
<figure markdown="span">
![Enter image alt description](Images/3j3_Image_8.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 8:</b> Swiss cheese model. ([source](https://www.safe.ai/ai-risk))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/XSY_Image_9.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 9:</b> A workflow for training and deploying a model responsibly. ([source](https://arxiv.org/abs/2305.15324))</figcaption>
</figure>
...
- **Open ****letters**: Initiatives like open letters, similar to the one from the Future of Life Institute ([source](https://futureoflife.org/open-letter/pause-giant-ai-experiments/)), can spark public debate on AI risks. 
