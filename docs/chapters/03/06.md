...
![Enter image alt description](Images/3j3_Image_8.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 3.8:</b> Swiss cheese model. ([source](https://www.safe.ai/ai-risk))</figcaption>
</figure>
...
![Enter image alt description](Images/XSY_Image_9.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 3.9:</b> A workflow for training and deploying a model responsibly. ([source](https://arxiv.org/abs/2305.15324))</figcaption>
</figure>
