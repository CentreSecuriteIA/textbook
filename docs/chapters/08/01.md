...
![Enter image alt description](Images/ICh_Image_1.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/7PZ_Image_2.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/Hxp_Image_3.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 8.3:</b> ([Wikipedia](https://en.wikipedia.org/wiki/Sudoku))</figcaption>
</figure>

**Examples: Illustrating Verification is Easier Than Generation**. Evaluation is easier than generation This is a very general property that holds across many domains:
