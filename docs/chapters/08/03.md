...
![Enter image alt description](Images/zOB_Image_6.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 8.6:</b> Example of process oversight feedback. ([Lightman et. al, 2023](https://arxiv.org/abs/2305.20050))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/ngX_Image_7.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 8.7:</b> Visualization of the dataset collection, training, and inference of BC and PC on a maze navigation task. ([Yang et. al; 2022](https://arxiv.org/abs/2205.10816))</figcaption>
</figure>
