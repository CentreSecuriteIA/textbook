...
![Enter image alt description](Images/paD_Image_26.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.26:</b> Stages of a cyberattack. The objective is to design benchmarks and evaluations that assess models’ ability to aid malicious actors with all four stages of a cyberattack. ([Li et al., 2024](https://arxiv.org/abs/2403.03218))</figcaption>
</figure>

<figure markdown="span">
![Enter image alt description](Images/1lJ_Image_27.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.27:</b> Biotechnology risk chain. The risk chain for developing a bioweapon starts with ideating a biological threat, followed by a design-build-test-learn (DBTL) loop. ([Li et al., 2024](https://arxiv.org/abs/2403.03218))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/e7I_Image_28.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.28:</b> An example of an automated red teaming framework - NYU CTF ([Shao et al., 2024](https://arxiv.org/abs/2406.05590))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/qvg_Image_29.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.29:</b> Distinguishing honesty, truthfulness, hallucination, deception, and scheming.</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/FDG_Image_30.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.30:</b> From DeepMind’s evaluation paper ([Phuong et al., 2024](https://arxiv.org/abs/2403.13793))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/Ue1_Image_31.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.31:</b> From METR’s report. ([METR, 2023](https://metr.org/blog/2023-08-01-new-report/))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/Apj_Image_32.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.32:</b> Illustration showing how increasing capabilities according to compute levels, might result in situational awareness in an LLM as a function of scale. ([Evans et al., 2023](https://www.alignmentforum.org/posts/mLfPHv4QjmeQrsSva/paper-on-measuring-situational-awareness-in-llms))</figcaption>
</figure>
