...
![Enter image alt description](Images/cNi_Image_36.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 35:</b> The relationship between an AI system’s capabilities, propensities, affordances, and behaviors. ([Sharkey et al., 2024](https://static1.squarespace.com/static/6593e7097565990e65c886fd/t/65a6f1389754fc06cb9a7a14/1705439547455/auditing_framework_web.pdf))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/oaN_Image_39.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 38:</b> The Aim is to avoid extreme risks from powerful misaligned model. ([Shevlane et al. 2023](https://arxiv.org/abs/2305.15324))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/wWX_Image_40.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 39:</b> Defense in depth ([Hendrycks, 2024](https://www.aisafetybook.com/textbook/component-failure-accident-models))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/rul_Image_41.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 40:</b> Determinants of AI system’s effects on the world and the types of auditing that act on them. ([Sharkey et al., 2024](https://static1.squarespace.com/static/6593e7097565990e65c886fd/t/65a6f1389754fc06cb9a7a14/1705439547455/auditing_framework_web.pdf))</figcaption>
</figure>
