...
??? note "Evaluation design inspiration from cognitive science"
...
![Enter image alt description](Images/9aA_Image_54.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.54:</b> The relationship between an AI system's capabilities, propensities, affordances, and behaviors. ([Sharkey et al., 2024](https://static1.squarespace.com/static/6593e7097565990e65c886fd/t/65a6f1389754fc06cb9a7a14/1705439547455/auditing_framework_web.pdf))</figcaption>
</figure>
...
??? note "How do model-written evaluations work?"
...
<figure markdown="span">
![Enter image alt description](Images/iXy_Image_57.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.57:</b> The aim is to avoid extreme risks from a powerful misaligned model ([Shevlane et al. 2023](https://arxiv.org/abs/2305.15324)).</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/vK9_Image_58.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.58:</b> Defense in depth ([Hendrycks, 2024](https://www.aisafetybook.com/textbook/component-failure-accident-models))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/LeM_Image_59.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.59:</b> Determinants of AI system’s effects on the world and the types of auditing that act on them. ([Sharkey et al., 2024](https://static1.squarespace.com/static/6593e7097565990e65c886fd/t/65a6f1389754fc06cb9a7a14/1705439547455/auditing_framework_web.pdf))</figcaption>
</figure>
