...
![Enter image alt description](Images/Equ_Image_36.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.36:</b> Basic setup for how we might structure control evaluations. ([Grenbaltt et al., 2024](https://arxiv.org/pdf/2312.06942.pdf))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/Nfq_Image_38.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.38:</b> Example process for the red team generating a single backdoor injection attempt. ([Grenbaltt et al., 2024](https://arxiv.org/pdf/2312.06942.pdf))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/0Mp_Image_39.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.39:</b> Illustration of how applying a safety or alignment technique could make the model less capable. This is called alignment/safety tax.</figcaption>
</figure>
