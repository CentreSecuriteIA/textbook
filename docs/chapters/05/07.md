...
![Enter image alt description](Images/qWN_Image_50.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.50:</b> Basic setup for how we might structure control evaluations ([Greenblatt et al., 2024](https://arxiv.org/pdf/2312.06942.pdf)).</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/p8p_Image_53.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.53:</b> Illustration of how applying a safety or alignment technique could make the model less capable. This is called safety tax.</figcaption>
</figure>
