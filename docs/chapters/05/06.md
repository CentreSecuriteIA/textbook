...
![Enter image alt description](Images/Vmr_Image_33.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.33:</b> Distinguishing honesty, truthfulness, hallucination, deception, and scheming.</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/GSN_Image_34.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.34:</b> Example of an AI black box lie detector. ([Pacchiardi et al., 2023)](https://arxiv.org/abs/2309.15840)</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/8CV_Image_35.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.35:</b> The path to scheming (deceptive alignment) involves deception with a long term motivation to achieve some unknown goal.</figcaption>
</figure>
