...
![Enter image alt description](Images/w5v_Image_29.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 29:</b> Distinguishing honesty, truthfulness, hallucination, deception, and scheming.</figcaption>
</figure>
...
![Enter image alt description](Images/XvD_Image_30.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 30:</b> Example of an AI black box lie detector. ([Pacchiardi et al., 2023)](https://arxiv.org/abs/2309.15840)</figcaption>
</figure>
...
![Enter image alt description](Images/U4z_Image_31.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 31:</b> The path to scheming (deceptive alignment) involves deception with a long term motivation to achieve some unknown goal.</figcaption>
</figure>
