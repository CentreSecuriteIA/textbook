...
![Enter image alt description](Images/M97_Image_2.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/JOw_Image_3.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/d9y_Image_4.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/HGK_Image_5.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/W4T_Image_6.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/rhl_Image_7.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/geT_Image_8.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.8:</b> Example of a Cesar Cipher</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/BEj_Image_9.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 5.9:</b> Example of the reversal curse ([Berglund et al., 2024](https://arxiv.org/abs/2309.12288))</figcaption>
</figure>
