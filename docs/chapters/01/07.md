# 1.7 Appendix 2: Discussions on LLMs {: #07 }
...
## 1.7.1 Empirically insufficiency? {: #01 }
...
## 1.7.2 Shallow Understanding? {: #02 }
...
## 1.7.3 Structural inadequacy? {: #03 }
...
## 1.7.4 Differences with the brain {: #04 }
...
## 1.7.5 Further reasons to continue scaling LLMs {: #05 }
