...
![Enter image alt description](Images/kIj_Image_27.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure:</b> A comparative illustration of combinations of slow and fast takeoff, alongside continuity. ([Martin & Eth, 2021](https://www.alignmentforum.org/posts/pGXR2ynhe5bBCCNqn/takeoff-speeds-and-discontinuities))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/AbI_Image_28.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure:</b> A summary of What a Compute-Centric Framework Says About Takeoff Speeds ([Davidson, 2024](https://www.openphilanthropy.org/research/what-a-compute-centric-framework-says-about-takeoff-speeds/))</figcaption>
</figure>
