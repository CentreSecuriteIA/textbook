...
![Enter image alt description](Images/Zoo_Image_36.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 35:</b> An illustration of slow takeoff which can be both continuous or discontinuous. ([Martin & Eth, 2021](https://www.alignmentforum.org/posts/pGXR2ynhe5bBCCNqn/takeoff-speeds-and-discontinuities))</figcaption>
</figure>

<figure markdown="span">
![Enter image alt description](Images/1Wi_Image_37.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 36:</b> A illustration of fast takeoff which can also be both continuous or discontinuous. ([Martin & Eth, 2021](https://www.alignmentforum.org/posts/pGXR2ynhe5bBCCNqn/takeoff-speeds-and-discontinuities))</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/lhe_Image_38.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 37:</b> A summary of What a Compute-Centric Framework Says About Takeoff Speeds ([Davidson, 2024](https://www.openphilanthropy.org/research/what-a-compute-centric-framework-says-about-takeoff-speeds/))</figcaption>
</figure>
