...
<figure markdown="span">
![Enter image alt description](Images/ROx_Image_27.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 2.27:</b> Probability of AI catastrophe under different policy scenarios. (source)</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/XPF_Image_28.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 2.28:</b> Illustration from Michael Trazzi describing Paul Christiano’s view of the future. Paul Christiano is a highly respected figure in the AI Safety community. ([source](https://www.lesswrong.com/posts/xWMqsvHapP3nwdSW8/my-views-on-doom))</figcaption>
</figure>
