...
??? note "What does goal-directed even mean?"
    ...
    ![Enter image alt description](Images/Cgw_Image_23.gif){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/UA3_Image_24.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/RmV_Image_25.gif){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/SGX_Image_26.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/b1w_Image_27.png){ loading=lazy }
