...
??? note "What does goal-directed even mean?"
    ...
    ![Enter image alt description](Images/0Yt_Image_13.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure 2.13:</b> ([source](https://www.alignmentforum.org/s/sCGfFb5DPfjEmtEdn/p/cAC4AXiNC5ig6jQnc))</figcaption>
    </figure>
    ...
    <figure markdown="span">
    ![Enter image alt description](Images/WkB_Image_14.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure 2.14:</b> ([source](https://www.alignmentforum.org/s/sCGfFb5DPfjEmtEdn/p/cAC4AXiNC5ig6jQnc))</figcaption>
    </figure>
...
<figure markdown="span">
![Enter image alt description](Images/ZCP_Image_15.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 2.15:</b> An illustration of Vingean uncertainty: Magnus Carlsen checkmates Bill Gates in 12 seconds, and this is not a surprise. Bill Gates knew he was going to lose, but not how. ([source](https://www.chess.com/news/view/bill-gates-vs-magnus-carlsen-checkmate-in-12-seconds-8224))</figcaption>
</figure>
...
!!! quote "Vernor Vinge, True Names and Other Dangers, p. 47. ([source](https://www.alignmentforum.org/s/sCGfFb5DPfjEmtEdn/p/cAC4AXiNC5ig6jQnc))"
...
!!! quote "Alan Turing, Intelligent Machinery, A Heretical Theory, 1951. ([source](https://en.wikipedia.org/wiki/Alan_Turing))"
...
<figure markdown="span">
![Enter image alt description](Images/M9g_Image_18.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 2.18:</b> ([source](https://www.alignmentforum.org/posts/GctJD5oCDRxCspEaZ/clarifying-ai-x-risk))</figcaption>
</figure>
