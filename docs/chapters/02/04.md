...
??? note "What does goal-directed even mean?"
    ...
    ![Enter image alt description](Images/bgo_Image_12.png)
    ...
    ![Enter image alt description](Images/gx9_Image_13.png)
...
![Enter image alt description](Images/bvr_Image_14.png)
...
![Enter image alt description](Images/adj_Image_15.png)
...
## 2.4.4 Paths to Existential Risks {: #04 }
...
![Enter image alt description](Images/fXH_Image_17.png)

***Figure:**** (**[source](https://www.alignmentforum.org/posts/GctJD5oCDRxCspEaZ/clarifying-ai-x-risk)**)*
