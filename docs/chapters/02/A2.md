...
## 2.A2.1 <span style="text - decoration: underline;">AI risks are non-enumerable</span> {: #01}
...
![Enter image alt description](Images/ASo_Image_37.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/cbz_Image_38.png){ loading=lazy }
