...
![Enter image alt description](Images/M3O_Image_9.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 9:</b> Fooling an image classifier with an adversarial attack (FGSM). ([source](https://openai.com/research/attacking-machine-learning-with-adversarial-examples))</figcaption>
</figure>
...
??? note "True Story: ChatGPT’s Release, Examples of Robustness Failures and Jailbreaks."
    ...
    ![Enter image alt description](Images/jt1_Image_10.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure 10:</b> ChatGPT's main example of safety measures on its website.</figcaption>
    </figure>
    ...
    ![Enter image alt description](Images/cVp_Image_11.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure 11:</b> A user posting a jailbreak on X.</figcaption>
    </figure>
    ...
    ![Enter image alt description](Images/nNa_Image_12.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure 12:</b> The sudo jailbreak, which no longer works</figcaption>
    </figure>
