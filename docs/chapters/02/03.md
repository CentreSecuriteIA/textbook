...
:fontawesome-regular-clock: Reading time: 15 minutes
...
![Enter image alt description](Images/4Dw_Image_9.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure:</b> Fooling an image classifier with an adversarial attack (FGSM). ([source](https://openai.com/research/attacking-machine-learning-with-adversarial-examples))</figcaption>
</figure>
...
??? note "True Story: ChatGPT’s Release, Examples of Robustness Failures and Jailbreaks."
    ...
    <figure markdown="span">
    ![Enter image alt description](Images/nWq_Image_10.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure:</b> ChatGPT's main example of safety measures on its website.</figcaption>
    </figure>
    ...
    <figure markdown="span">
    ![Enter image alt description](Images/yog_Image_11.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure:</b> A user posting a jailbreak on X.</figcaption>
    </figure>
    ...
    <figure markdown="span">
    ![Enter image alt description](Images/n2Y_Image_12.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure:</b> The sudo jailbreak, which no longer works</figcaption>
    </figure>
...
!!! quote "Albert Einstein ([source](https://www.goodreads.com/quotes/14977-i-know-not-with-what-weapons-world-war-iii-will))"
