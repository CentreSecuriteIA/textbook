...
:fontawesome-regular-clock: Reading time: 1 minutes
...
![Enter image alt description](Images/7Za_Image_24.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure:</b> XKCD ([source](https://xkcd.com/))</figcaption>
</figure>