...
??? note "CICERO: A Case Study of AI Manipulation ([Park et al., 2023](https://arxiv.org/abs/2308.14752))"
    ...
    ![Enter image alt description](Images/x1e_Image_33.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/oSe_Image_34.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/pfG_Image_35.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/WkC_Image_36.png){ loading=lazy }
...
??? note "Algorithm. Auto-GPT: Converting a tool AI into an agent AI with scaffolding.."
    ...
    <figure markdown="span">
    ![Enter image alt description](Images/4kf_Image_37.png){ loading=lazy }
