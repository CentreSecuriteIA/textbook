...
??? note "Anecdote: Steinhardt’s forecasting contest"
    ...
    ![Enter image alt description](Images/ayh_Image_5.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure 5:</b> Experts have been consistently underestimating the pace of AI progress.</figcaption>
    </figure>
    ...
    <figure markdown="span">
    ![alt_text](Images/5xk-alt_text.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure 6:</b> Another prediction distribution by experts in 2022, that way undershot expected capabilities.</figcaption>
    </figure>
...
<figure markdown="span">
![Enter image alt description](Images/yjY_Image_7.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 7:</b> For illustrative purposes. Figure from the French Center for AI Safety’s agenda.</figcaption>
</figure>
...
<figure markdown="span">
![Enter image alt description](Images/JvT_Image_8.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure 8:</b> Kargu-2 ([source](https://lieber.westpoint.edu/wp-content/uploads/2021/06/STM_Kargu.png))</figcaption>
</figure>
