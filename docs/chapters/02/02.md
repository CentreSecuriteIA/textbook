...
![Enter image alt description](Images/kwU_Image_5.png){ loading=lazy }
...
<figure markdown="span">
![alt_text](Images/jyT-alt_text.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/nvs_Image_7.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/R3w_Image_8.png){ loading=lazy }
