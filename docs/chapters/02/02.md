# 2.2 Risk Amplifiers {: #02 }

:fontawesome-regular-clock: Reading time: 14 minutes
...
??? note "Anecdote: Steinhardt’s forecasting contest"
    ...
    [^2]: A person who makes forecasts that can be shown by statistical means to have been consistently more accurate than the general public or experts. ([Wikipedia](https://en.wikipedia.org/wiki/Superforecaster))

    In mid-2021, ML professor Jacob Steinhardt ran a contest to predict progress on MATH and MMLU, two famous benchmarks.

    <figure markdown="span">
    ![Enter image alt description](Images/f2p_Image_5.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure:</b> Experts have been consistently underestimating the pace of AI progress.</figcaption>
    </figure>
    ...
    <figure markdown="span">
    ![alt_text](Images/tjd-alt_text.png){ loading=lazy }
      <figcaption markdown="1"><b>Figure:</b> Another prediction distribution by experts in 2022, that way undershot expected capabilities.</figcaption>
    </figure>
...
<figure markdown="span">
![Enter image alt description](Images/gtz_Image_7.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure:</b> For illustrative purposes. Figure from the French Center for AI Safety’s agenda.</figcaption>
</figure>

## 2.2.4 Deployment Scale {: #04 }
...
<figure markdown="span">
![Enter image alt description](Images/MiX_Image_8.png){ loading=lazy }
  <figcaption markdown="1"><b>Figure:</b> Kargu-2 ([source](https://lieber.westpoint.edu/wp-content/uploads/2021/06/STM_Kargu.png))</figcaption>
</figure>
...
## 2.2.6 Coordination Challenges {: #06 }
