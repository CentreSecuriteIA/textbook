...
??? note "Anecdote: Steinhardt’s forecasting contest"
    ...
    ![Enter image alt description](Images/1MU_Image_5.png){ loading=lazy }
    ...
    <figure markdown="span">
    ![alt_text](Images/CPw-alt_text.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/QB2_Image_7.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/jQ0_Image_8.png){ loading=lazy }
