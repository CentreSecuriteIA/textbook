...
??? note "Anecdote: Steinhardt’s forecasting contest"
    ...
    ![Enter image alt description](Images/9Jd_Image_5.png){ loading=lazy }
    ...
    <figure markdown="span">
    ![alt_text](Images/QWS-alt_text.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/sLd_Image_7.png){ loading=lazy }
...
<figure markdown="span">
![Enter image alt description](Images/cmI_Image_8.png){ loading=lazy }
...
!!! quote "Max Tegmark ([Tegmark, 2023](https://time.com/6273743/thinking-that-could-doom-us-with-ai/))"
