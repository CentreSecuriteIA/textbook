# 1.8 Appendix 2: Discussions on LLMs

⌛ Estimated Reading Time: 21 minutes. (4180 words)
...
## 1.8.1 Empirically insufficiency?
...
## 1.8.4 Differences with the brain
...
## 1.8.5 Further reasons to continue scaling LLMs
