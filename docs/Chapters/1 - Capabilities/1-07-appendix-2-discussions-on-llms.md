# 1.7 Appendix 2: Discussions on LLMs
...
## 1.7.1 Empirically insufficiency?
...
## 1.7.4 Differences with the brain
...
## 1.7.5 Further reasons to continue scaling LLMs
