...
![Enter image alt description](Images/B3j_Image_26.png)


***Figure****: Here is another framework that is very different from what we presented.*

![Enter image alt description](Images/eYM_Image_27.png)
...
![Enter image alt description](Images/pRA_Image_28.png)
